package com.hazelnut.myjobs.User.Pelamar.Login;
...
import com.hazelnut.myjobs.User.Pelamar.Main.MainUserAct;
import com.hazelnut.myjobs.User.Pelamar.Register.RegisterUserAct;
...
import com.hazelnut.myjobs.databinding.ActivityLoginUserBinding;

import retrofit2.Call;
import retrofit2.Callback;
import retrofit2.Response;

public class LoginUserAct extends AppCompatActivity {

    private ActivityLoginUserBinding loginBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginBinding = DataBindingUtil.setContentView(this, R.layout.activity_login_user);
        appConfig = new AppConfig(this);
        if (appConfig.isUserLogin()) {
            String nama = appConfig.getNameOfPelamar();
            Integer id  = appConfig.getIdOfPelamar();
            Intent intent = new Intent(LoginUserAct.this, MainUserAct.class);
        ...
        loginBinding.tvCreateaccount.setOnClickListener(v -> {
            startActivity(new Intent(LoginUserAct.this, RegisterUserAct.class));
        });
    ...
    public void performLogin() {
        ...
        Call<ApiResponse> call = ApiClient.getApiClient().create(ApiInterface.class).UserLogin(username, password);
                ...
                if(response.code() == 200) {
                    ...
                    if(response.body().getStatus().equals("ok")) {
                        ...
                        if(response.body().getResultCode() == 1) {
                            ...
                            Integer id = response.body().getIdPelamar();
                            if (isRememberUserLogin){
                                appConfig.updateUserLoginStatus(true);
                                appConfig.saveNameOfPelamar(nama);
                                appConfig.saveIdOfPelamar(id);
                            }
                            Intent intent = new Intent(LoginUserAct.this, MainUserAct.class);
                            startActivity(intent);
                            finish();
